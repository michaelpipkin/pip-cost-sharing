  ...
  private readonly helpSections: HelpSection[] = [
    ...
    },
    {
      ...
      content: [
        ...
        'Click the Add New Expense button to choose how to create a new expense: a manual entry, a photo scan of a receipt, or (if not everyone stayed every night) a guided Vacation Rental split - see the Create Expense From Receipt and Vacation Rental help sections for details.',
    ...
    },
    {
      ...
      content: [
        ...
        'The running totals show what each assigned member owes for their own items, plus a combined Shared Pool total (tax, tip, and any unassigned items) that gets split evenly among assigned members.',
